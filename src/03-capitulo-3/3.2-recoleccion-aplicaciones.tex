...
Este sistema consiste en una aplicación desarrollada en el \eng{framework}
...
apoyarse en el \eng{hook} \lstinline{"process_action.action_controller"} y enviar a
\gls{term:influx} información sobre los tiempos de respuesta de cada petición
\eng{web}, distinguiendo el tiempo que demora en el \eng{renderizado} de las vistas,
...
Hemos escrito una explicación un poco más detallada de \eng{Compose} en el
