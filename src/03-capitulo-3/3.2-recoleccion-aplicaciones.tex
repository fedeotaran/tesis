...
La línea FROM ruby:2.3.1 declara que el contenedor se basa en la imagen de Docker de nombre ruby:2.3.1. La siguiente lìnea se ocupa de instalar las librerías necesarias para usar la aplicación Rails.
