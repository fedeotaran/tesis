...
importancia de la aplicación de monitoreo en proyectos de \eng{software}.
...
Se denomina \eng{log} al registro de una operación en una computadora, usualmente
almacenado en un archivo. En la \autoref{utilidad-de-los-logs} se profundizará
en la definición de \eng{log} y se abordará su utilidad para el monitoreo.
Además se explicarán las partes de un \eng{log}, su formato y las dificultades más comunes a la hora de manipular este tipo de registros.
