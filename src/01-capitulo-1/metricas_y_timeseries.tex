\subsection{Métricas y time-series}
...
Los percentiles facilitan la interpretación de la distribución; Por ejemplo, para medir el tiempo de respuesta un valor p98 de 3 segundos significa que el 98% de todas las solicitudes se completó en 3 segundos o menos. Por el contrario, el 2% de las solicitudes más lentas tomaron 3 segundos o más.
...
Los datos en un time-series son presentados en una granularidad de tiempo fijo. Una granularidad fina se traduce en períodos cortos de valores. Cuanto más gruesa sea la granularidad, más largo será el período.
