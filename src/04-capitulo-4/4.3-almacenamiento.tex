...
\eng{web} RESTful y con documentos JSON. Elasticsearch está desarrollado en
...
Es posible comunicarse con esta API mediante clientes \eng{web}, y también
...
sitio \eng{web} de Elasticsearch.
