...
\eng{plugins} para recolectar y procesar logs. Además permite dirigir las
...
\gls{term:splunk} es una herramienta comercial para buscar, monitorizar y
...
recolección, filtrado, \eng{buffering} y envío de logs a través de múltiples
fuentes y destinos.
...
partes importantes del mensaje (\eng{host}, \eng{user} y \eng{time}):
...
valores son la marca de tiempo, el tipo de solicitud \eng{web}, la URL a
...
Se puede encontrar una descripción más completa de Compose en el \autoref{anexo:C}.
