...
rendimiento. Es \eng{software} libre y de código abierto, y está licenciado bajo la
...
\gls{term:nginx} escribe información sobre solicitudes de clientes en el \texttt{\eng{access
...
\eng{drivers}. También en este caso utilizaremos la herramienta
\gls{term:fluentd} para recolectar los \eng{logs}, por lo que usaremos el driver
