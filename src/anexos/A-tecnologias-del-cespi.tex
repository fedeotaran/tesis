...
\begin{itemize}
  ...
  \item \textbf{Orquestación y programación de contenedores:}
    ...
    incluye una distribución de todos los \eng{frameworks} populares hoy en
    día, incluyendo Docker Swarm, Kubernetes y Mesos. Un mismo usuario puede
    crear múltiples \eng{clusters} de Swarm o Kubernetes, y luego usar las
  ...
  \item \textbf{Control de nivel empresarial:}
    Rancher soporta \eng{plugins} de autenticación de usuarios flexibles y
