...
licencia de \eng{software} libre.
...
aplicaciones \eng{web} de código abierto escrito en el lenguaje de programación
...
El lenguaje de programación \gls{term:ruby} permite la metaprogramación, de la
...
En la práctica, \gls{term:docker} puede ser utilizado para simplificar la
...
\begin{itemize}
  ...
  \item \textbf{Orquestación y programación de contenedores:}
    ...
    una distribución de todos los \eng{frameworks} populares hoy en día,
    incluyendo Docker Swarm, Kubernetes y Mesos. Un mismo usuario puede crear
    múltiples \eng{clusters} de Swarm o Kubernetes, y luego usar las
    herramientas nativas de estos \eng{frameworks} para manejar sus
    aplicaciones.
  ...
  \item \textbf{Catálogo de aplicación:}
    ...
    \eng{clusters} desde el catálogo de aplicación presionando un único botón.
  ...
  \item \textbf{Control de nivel empresarial:}
    Rancher soporta \eng{plugins} de autenticación de usuarios flexibles y viene por defecto con integración de autenticación de usuarios con
