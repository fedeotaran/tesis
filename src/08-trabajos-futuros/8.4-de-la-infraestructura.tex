...
El sistema de monitoreo es un sistema de \eng{software}, y como tal, no es inmune a
fallos, \eng{bugs} o comportamientos inesperados. Puede ser importante tener un
