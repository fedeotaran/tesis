...
generar alertas y definir canales de procesamiento de datos, o \eng{pipelines}.

Un \eng{pipeline} es un conjunto de nodos que procesa datos y
aristas que conectan nodos. Los \eng{pipelines} en \gls{term:kapacitor} son grafos
