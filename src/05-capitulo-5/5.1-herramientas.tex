...
Las herramientas de \eng{software} de visualización de datos son aquellas que ocupan
...
Pero \gls{term:kibana} es un \eng{frontend} de \gls{term:elasticsearch} y está preparado
...
de \eng{logs} tal cual fueron recuperados e indexados.
...
acerca de los \eng{logs}, y \gls{term:grafana} para comunicarse con nuestra instancia
